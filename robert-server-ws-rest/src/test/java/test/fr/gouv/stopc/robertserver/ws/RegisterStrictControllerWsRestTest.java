...
public class RegisterStrictControllerWsRestTest {
	...
	HttpEntity<RegisterStrictVo> requestEntity;

	private URI targetUrl;

	private RegisterStrictVo body;
	...
	@MockBean
	private CaptchaStrictService captchaStrictService;
	...
	public void testBadHttpVerb() {
		this.body = RegisterStrictVo.builder().captcha("TEST").captchaId("92c9623a7c474c4a92661614cd29d08b").build();
...
//	}
	...
	public void testCaptchaFailure() {
		this.body = RegisterStrictVo.builder()
		...
		doReturn(false).when(this.captchaStrictService).verifyCaptcha(ArgumentMatchers.any());
    ...
    public void testRegisterFailsWhenRegistrationFails() {
        ...
        // CAPTCHA passes
        doReturn(true).when(this.captchaStrictService).verifyCaptcha(ArgumentMatchers.any());
	...
	public void testSuccess() {
		...
		when(this.captchaStrictService.verifyCaptcha(this.body)).thenReturn(true);
